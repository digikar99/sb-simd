...
(loop
  for (name             mnemonic  result-records argument-records emitter             one-arg-fn .         attributes) in
  '(;; Casts
    (  f32.4-from-f64.4 vcvtpd2ps (f32.4)        (f64.4)          #'default-emitter   nil :cost 5)
    (  f64.4-from-f32.4 vcvtps2pd (f64.4)        (f32.4)          #'default-emitter   nil :cost 5)
    ;; 128 bit arithmetic operations
    (  two-arg-f64.2-+  addpd     (f64.2)        (f64.2 f64.2)    #'default-emitter   nil :cost 2 :first-arg-stores-result t :commutative t)
    (  two-arg-f64.2--  subpd     (f64.2)        (f64.2 f64.2)    #'default-emitter   (one-arg-f64.2-- (a)
                                                                                        (two-arg-f64.2-- (f64.2 0) a)) :cost 2 :first-arg-stores-result t)
    (  two-arg-f64.2-*  mulpd     (f64.2)        (f64.2 f64.2)    #'default-emitter   nil :cost 2 :first-arg-stores-result t :commutative t)
    (  two-arg-f64.2-/  divpd     (f64.2)        (f64.2 f64.2)    #'default-emitter   (one-arg-f64.2-/ (a)
                                                                                        (two-arg-f64.2-/ (f64.2 1) a)) :cost 8 :first-arg-stores-result t)
    (  two-arg-f32.4-+  addps     (f32.4)        (f32.4 f32.4)    #'default-emitter   nil :cost 2 :first-arg-stores-result t :commutative t)
    (  two-arg-f32.4--  subds     (f32.4)        (f32.4 f32.4)    #'default-emitter   (one-arg-f32.4-- (a)
                                                                                        (two-arg-f32.4-- (f32.4 0) a)) :cost 2 :first-arg-stores-result t)
    (  two-arg-f32.4-*  mulps     (f32.4)        (f32.4 f32.4)    #'default-emitter   nil :cost 2 :first-arg-stores-result t :commutative t)
    (  two-arg-f32.4-/  divps     (f32.4)        (f32.4 f32.4)    #'default-emitter   (one-arg-f32.4-/ (a)
                                                                                        (two-arg-f32.4-/ (f32.4 1) a)) :cost 8 :first-arg-stores-result t)
    ;; 128 bit comparisons
    ;; 256 bit arithmetic operations
    (  two-arg-f64.2-+  vaddpd    (f64.2)        (f64.2 f64.2)    #'default-emitter   nil :cost 2 :commutative t)
    (  two-arg-f64.2--  vsubpd    (f64.2)        (f64.2 f64.2)    #'default-emitter   (one-arg-f64.2-- (a)
                                                                                        (two-arg-f64.2-- (f64.2 0) a)) :cost 2)
    (  two-arg-f64.2-*  vmulpd    (f64.2)        (f64.2 f64.2)    #'default-emitter   nil :cost 2 :commutative t)
    (  two-arg-f64.2-/  vdivpd    (f64.2)        (f64.2 f64.2)    #'default-emitter   (one-arg-f64.2-/ (a)
                                                                                        (two-arg-f64.2-/ (f64.2 1) a)) :cost 8)
    (  two-arg-f32.4-+  vaddps    (f32.4)        (f32.4 f32.4)    #'default-emitter   nil :cost 2 :commutative t)
    (  two-arg-f32.4--  vsubds    (f32.4)        (f32.4 f32.4)    #'default-emitter   (one-arg-f32.4-- (a)
                                                                                        (two-arg-f32.4-- (f32.4 0) a)) :cost 2)
    (  two-arg-f32.4-*  vmulps    (f32.4)        (f32.4 f32.4)    #'default-emitter   nil :cost 2 :commutative t)
    (  two-arg-f32.4-/  vdivps    (f32.4)        (f32.4 f32.4)    #'default-emitter   (one-arg-f32.4-/ (a)
                                                                                        (two-arg-f32.4-/ (f32.4 1) a)) :cost 8)
    (  two-arg-f64.4-+  vaddpd    (f64.4)        (f64.4 f64.4)    #'default-emitter   nil :cost 2 :commutative t)
    (  two-arg-f64.4--  vsubpd    (f64.4)        (f64.4 f64.4)    #'default-emitter   (one-arg-f64.4-- (a)
                                                                                        (two-arg-f64.4-- (f64.4 0) a)) :cost 2)
    (  two-arg-f64.4-*  vmulpd    (f64.4)        (f64.4 f64.4)    #'default-emitter   nil :cost 2 :commutative t)
    (  two-arg-f64.4-/  vdivpd    (f64.4)        (f64.4 f64.4)    #'default-emitter   (one-arg-f64.4-/ (a)
                                                                                        (two-arg-f64.4-/ (f64.4 1) a)) :cost 8)
    (  two-arg-f32.8-+  vaddps    (f32.8)        (f32.8 f32.8)    #'default-emitter   nil :cost 2 :commutative t)
    (  two-arg-f32.8--  vsubps    (f32.8)        (f32.8 f32.8)    #'default-emitter   (one-arg-f32.8-- (a)
                                                                                        (two-arg-f32.8-- (f32.8 0) a)) :cost 2)
    (  two-arg-f32.8-*  vmulps    (f32.8)        (f32.8 f32.8)    #'default-emitter   nil :cost 2 :commutative t)
    (  two-arg-f32.8-/  vdivps    (f32.8)        (f32.8 f32.8)    #'default-emitter   (one-arg-f32.8-/ (a)
                                                                                        (two-arg-f32.8-/ (f32.8 1) a)) :cost 8)
    ;; 256 bit comparisons
    ( two-arg-f32.8-<=  vcmpps    (u64.4)        (f32.8 f32.8)    (cmp-emitter :le)   nil :cost 8)
    )
  when (find-symbol (string mnemonic) sb-assem::*backend-instruction-set-package*)
    do (setf (gethash name *instruction-records*)
             (make-instruction-record
              ...
              :one-arg-fn (the list one-arg-fn)
